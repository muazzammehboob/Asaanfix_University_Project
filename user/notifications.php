<?php
/**
 * AsaanFix Pakistan - User Notifications
 */
...
<div class="dashboard-content">
    ...
    <div class="card-custom p-3 mb-2 <?= $n['is_read'] ? '' : 'border-start border-primary border-3' ?>" style="<?= $n['is_read'] ? '' : 'background:rgba(var(--primary-rgb),0.02);' ?>">
